...
const page = () => {
    return (
        <div className="flex justify-center"  >
            <section className="text-gray-400 body-font lg:ml-10 lg:pl-10 ">
                <h1 className="title-font sm:text-3xl text-xl font-bold text-gray-800">Experience
                </h1>
                <div className="container px-5 py-20 mx-auto flex flex-wrap">
                    <div className="flex flex-wrap -m-4">
                        <div className="p-4 lg:w-full lg:pl-24 md:w-full">
                            <div className="flex p-8 sm:flex-row flex-col">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <h2 className="text-gray-900 text-xl title-font font-bold mb-3">Shooting Stars</h2>
