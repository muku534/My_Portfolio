        ...
        <>
            ...
            <div className="flex w-full mt-20 p-20 justify-center items-center  bg-gradient-to-r from-indigo-100 to-indigo-100" >
                <div className="text-center">
                    ...
                    <Link href="#" className="inline-flex items-center justify-center mt-4 px-10 py-3 text-base font-medium text-center text-white bg-indigo-500 rounded-full hover:bg-indigo-600 focus:ring-4 focus:ring-indigo-800 dark:focus:ring-indigo-700">
                        Hire Me
                    </Link>
                </div>
            </div>
